...
import com.sbmlmerge.gui.TaskListener;
...
public abstract class NotificationThread implements Runnable{
    ...
    private final java.util.List<TaskListener> listeners;
    ...
    /**
     * Removes a particular listener from this object, or does nothing if 
